...
person_df1 <- read.csv('D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/tidynomicon/person.csv')
str(person_df1)
...
person_df2 <- read.csv('D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/tidynomicon/person.csv',
                       stringsAsFactors = FALSE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv('D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/scores.csv',
                      stringsAsFactors = FALSE)
summary(scores_df)
...
excel_sheets('D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/G04ResultsDetail2004-11-02.xls')
...
voter_turnout_df1 <- read_excel('D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/G04ResultsDetail2004-11-02.xls',
                                sheet = 'Voter Turnout',
                                skip = 1)
...
voter_turnout_df2 <- read_excel('D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/G04ResultsDetail2004-11-02.xls',
                                                     sheet = 'Voter Turnout',
                                                     skip = 2,
...
db <- dbConnect(RSQLite::SQLite(),
                "D:/data science/DSC520-T301 Statistics for Data Science/GetHub/dsc520/data/tidynomicon/example.db")
